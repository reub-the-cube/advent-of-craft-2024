...
public class EncryptionTests
{
    ...
    [Fact]
    public void Encrypt_Email_Message()
    {
        var unencryptedMessage = @"Dear consultant,
...
Santa Claus 🎅";
        var expectedEncryption = FileUtils.LoadFile("EncryptedEmail.txt");

        var encryptedMessage = _encryption.Encrypt(unencryptedMessage);
        
        encryptedMessage.Should().Be(expectedEncryption);
    }
}